package com.abc.woof.data

import androidx.annotation.DrawableRes
import androidx.annotation.StringRes
import androidx.compose.ui.tooling.preview.PreviewParameterProvider
import com.abc.woof.R
...
class DogDataProvider : PreviewParameterProvider<Dog> {
    override val values = sequenceOf(
        Dog(R.drawable.koda, R.string.dog_name_1, 2, R.string.dog_description_1)
    )
}

class DogListDataProvider : PreviewParameterProvider<List<Dog>> {
    override val values = sequenceOf(dogs)
}